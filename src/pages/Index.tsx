    ...
    <div className="min-h-screen bg-background">
                ...
                <CardContent className="p-8">
                  ...
                  <div className="space-y-6">
                    <div className="p-4 bg-blue-50 rounded-lg border-l-4 border-primary">
                      <div className="font-semibold text-primary mb-1 text-base">Business Owner</div>
              ...
              <CardContent className="p-8 md:p-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                  <div className="text-center p-4">
                    ...
                    <h4 className="font-semibold text-base mb-2">Economic Growth</h4>
                  ...
                  <div className="text-center p-4">
                    ...
                    <h4 className="font-semibold text-base mb-2">Problem Solving</h4>
                  ...
                  <div className="text-center p-4">
                    ...
                    <h4 className="font-semibold text-base mb-2">Social Impact</h4>
      ...
      <AnimatedSection animation="scale" className="py-12 sm:py-16 lg:py-24 bg-background px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="card-hover rounded-xl lg:rounded-2xl shadow-2xl overflow-hidden aspect-video border border-border mb-6">
            <iframe
              ...
              <AnimatedSection key={program.title} animation="scale" delay={index * 0.1}>
                ...
                >
                  <CardHeader className="text-center p-6">
                    ...
                    <CardTitle className="hover:text-primary transition-colors text-lg">{program.title}</CardTitle>
                    <CardDescription className="text-sm">{program.desc}</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4 p-6 pt-0">
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      ...
                      {program.features.length > 3 && (
                        <li className="text-primary font-medium text-center pt-2 text-sm">
              ...
              <AnimatedSection key={member.name} animation="scale" delay={index * 0.1}>
                <Card className="group bg-white/60 backdrop-blur-lg shadow-2xl border-0 hover-lift card-hover overflow-hidden">
                  <CardContent className="flex flex-col items-center p-8 relative">
                    ...
                    <p className="text-sm text-accent text-center">{member.dept}</p>
                  </CardContent>
                </Card>
              </AnimatedSection>
            ))}
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div key={contact.title} className={`flex items-start space-x-4 hover-lift p-4 rounded-lg transition-all duration-300 delay-${index * 100}`}>
                    <contact.icon className="w-6 h-6 text-primary mt-1 flex-shrink-0" />
                    <div className="min-w-0 flex-1">
                      <h4 className="font-semibold text-base mb-2">{contact.title}</h4>
                      <a
                        href={contact.link}
                        target={contact.link.startsWith('http') ? '_blank' : undefined}
                        rel={contact.link.startsWith('http') ? 'noopener noreferrer' : undefined}
                        className="text-muted-foreground hover:text-primary transition-colors whitespace-pre-line hover-scale inline-block text-base break-words"
                      >
                        {contact.content}
                      </a>
                    </div>
          ...
          <div className="flex flex-col items-center justify-center gap-4">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 w-full max-w-2xl">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-primary text-primary-foreground rounded-full font-semibold shadow hover:bg-primary/90 hover-lift btn-primary text-base"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-green-600 text-white rounded-full font-semibold shadow hover:bg-green-700 hover-lift text-base"
